...
#include "Robot.h"
#include "../Debug/src/GitVersion.h"

// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZATION
std::shared_ptr<BallIntake> Robot::ballIntake;
std::shared_ptr<DriveTrain> Robot::driveTrain;
std::shared_ptr<Flapper> Robot::flapper;
...
void Robot::RobotInit() {
	...
	SmartDashboard::PutNumber("Autonomous Decision", 0.0);
...
//	double encoderValue = RobotMap::driveTraindriveEncoder->Get();
//	printf("\nEncoder Value: %f", encoderValue);
}
