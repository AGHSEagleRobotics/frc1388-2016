...
std::shared_ptr<Ultrasonic> RobotMap::ballIntakeBallDetector;
...
void RobotMap::init() {
    ...
    lw->AddActuator("BallIntake", "ShootMotor", std::static_pointer_cast<TalonSRX>(ballIntakeShootMotor));
    ...
    ballIntakeBallDetector.reset(new Ultrasonic(0, 1));
    lw->AddSensor("BallIntake", "BallDetector", ballIntakeBallDetector);
