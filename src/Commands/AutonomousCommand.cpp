...
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	...
	case 1: // APPROACH
		...
		break;
	case 2: // CROSS WITH NO FLAPPER
		DriveNoFlapper();
		break;
	case 3: //CROSS WITH FLAPPER
		DriveWithFlapper();
...
void AutonomousCommand::DriveWithFlapper(){
...
void AutonomousCommand::DriveNoFlapper(){
